...
export interface RenderResult {
  html?: string;
  redirect?: string;
  error?: import("../errors.ts").VibeframeError;
}
    ...
    try {
      ...
      if (!validateCSRFToken(csrfToken)) {
        return {
          ...
          error: new (await import("../errors.ts")).VibeframeError("VIBEFRAME_CSRF_001", "CSRF validation failed", "The CSRF token is invalid or expired.", "Refresh the page and resubmit the form."),
        };
      }
    } catch {
